"""
Central configuration for HU4 pipeline (opencode).
- Keep ARNs out of code; read from environment.
- Adjust SCRIPTS_PREFIX if scripts are uploaded to a different S3 path.
"""
...
# Ubicación de scripts en S3 (sube los .py a esta ruta)
SCRIPTS_PREFIX = f"s3://{BUCKET}/scripts/opencode/"
