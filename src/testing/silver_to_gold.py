...
asset_col = args.get("ASSET_COL") or config.ASSET_COL
time_col = args.get("TIME_COL") or config.TIME_COL
close_col = args.get("CLOSE_COL") or config.CLOSE_COL
partition_cols = [c.strip() for c in (args.get("PARTITION_COLS") or config.PARTITION_COLS).split(",") if c.strip()]
